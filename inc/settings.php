							...
							<li>
								   ...
								   <table class="form-table">
									   <tbody>
											...
											<td><a href="<?php echo esc_url( 'https://documentcloud.adobe.com/dc-integration-creation-app-cdn/main.html?api=pdf-embed-api' ); ?>" target="_blank"><?php esc_html_e( 'Get your Adobe API Key', 'embed-any-document' ); ?></a><br/><a href="<?php echo esc_url( 'https://docs.embedanydocument.com/configuring-cloud-apis/getting-adobe-api-key' ); ?>" target="_blank"><?php esc_html_e( 'Guide to generate Adobe API Key', 'embed-any-document' ); ?></a></td>
											</tr>
									   </tbody>
								   </table>
							   </li>
