    ...
    <div class="row clearfix">
        ...
        <div class="ead-right-wrap">
                ...
                <div class="clearfix row-2 ead-right-widget">
                   ...
                   <img src="<?php echo $this->plugin_url;?>images/star.gif"><?php esc_html_e('Like the plugin?', 'embed-any-document');?><br/><?php esc_html_e('Rate Now!', 'embed-any-document');?>
                   </a>
                    </div>
                    <!-- .col-2 -->
                    <div class="col-2">
                        <a href="http://awsm.in/support" target="_blank">
                   <img src="<?php echo $this->plugin_url;?>images/ticket.gif"><?php esc_html_e('Need Help?', 'embed-any-document');?><br/><?php esc_html_e('Open a Ticket', 'embed-any-document');?>
                   </a>
                    </div>
                    <!-- .col-2 -->
                </div>
