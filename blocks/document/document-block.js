...
var EadInspector = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EadInspector, [{
    ...
    value: function render() {
      ...
      return wp.element.createElement(InspectorControls, null, wp.hooks.doAction('awsm_ead_before_block_settings'), wp.element.createElement(PanelBody, null, wp.element.createElement(TextControl, {
