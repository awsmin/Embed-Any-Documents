...
registerBlockType('embed-any-document/document', {
  ...
  edit: function edit(props) {
    ...
    var blockProps = null;
    var shortcodeText;
    var embedurl; // Set an Unique Id for the block.
    ...
    var eadShortcode = function eadShortcode(embedurl) {
      ...
      var defaultViewer = 'google';

      if (typeof eadPublic !== 'undefined' && eadPublic.adobe_api_key && _modules_helper__WEBPACK_IMPORTED_MODULE_0__["default"].isPDF(url)) {
        defaultViewer = 'adobe';
      } else if (_modules_helper__WEBPACK_IMPORTED_MODULE_0__["default"].isValidMSExtension(url)) {
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.state.response !== prevState.response && null !== this.eadRef.current) {
        ...
        if (attributes !== null && attributes && (attributes.viewer === 'google' || attributes.viewer === 'browser' || attributes.viewer === 'built-in' || attributes.viewer === 'adobe')) {
          ...
          if (viewer === 'adobe') {
            var validateAdobeDC;
            validateAdobeDC = setInterval(function () {
...
var EadInspector = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EadInspector, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      if (_helper__WEBPACK_IMPORTED_MODULE_0__["default"].isPDF(this.props.attributes.url) && _helper__WEBPACK_IMPORTED_MODULE_0__["default"].getFileSource(this.props.attributes.url) === 'internal') {
    ...
    value: function render() {
      ...
      * @since 3.0.0
      */
      wp.hooks.doAction('awsm_ead_before_block_settings'), wp.element.createElement(PanelBody, null, wp.element.createElement(TextControl, {
        ...
        disabled: true,
        label: __('Show Print PDF', 'embed-any-document')
      }), wp.element.createElement(ToggleControl, {
        disabled: true,
        ...
        disabled: true,
        label: __('View Mode', 'embed-any-document'),
        options: [{
      ...
      * @since 3.0.0
      */
      wp.hooks.doAction('awsm_ead_after_block_settings', viewerSettings, viewer, this.props), viewerSettings);
    }
  }]);
